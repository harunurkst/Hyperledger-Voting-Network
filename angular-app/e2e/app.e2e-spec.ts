...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be voting-network@0.0.1',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('voting-network@0.0.1.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Party component should be loadable',() => {
      page.navigateTo('/Party');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Party');
      });
    });

    it('Party table should have 3 columns',() => {
      page.navigateTo('/Party');
    ...
    it('Voter table should have 4 columns',() => {
      page.navigateTo('/Voter');
      element.all(by.css('.thead-cols th')).then(function(arr) {
